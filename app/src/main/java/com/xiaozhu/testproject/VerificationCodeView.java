...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, @Nullable AttributeSet attrs) {
        ...
        mEtTextBg = typedArray.getResourceId(R.styleable.verificationCodeView_vcv_et_bg, R.drawable.ed_shape_oval);
        mCursorDrawable = typedArray.getResourceId(R.styleable.verificationCodeView_vcv_et_cursor, R.drawable.ed_cursor_green);
        typedArray.recycle();
        initView();
